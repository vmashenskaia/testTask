...
//Для имитации полок использованы коллайдеры
//Этот код реализует логику перетаскивания объекта в Unity с использованием мыши,
//отключая физику и перемещение камеры во время перетаскивания